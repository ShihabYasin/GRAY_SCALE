...
import os
################################################################
files = glob.glob('/home/shihab/OCR_PRESCRIPTION/GRAY_SCALE/out/*')
for f in files:
    os.remove(f)

img = cv2.imread('/home/shihab/OCR_PRESCRIPTION/GRAY_SCALE/test.jpg')
...
n_boxes = len(d['level'])
prev_x=-1; prev_y=-1; prev_w=-1; prev_h=-1
...
for i in range(n_boxes):
    ...
    if (curr_line_height > prev_line_height):
        ...
        cv2.imwrite("/home/shihab/OCR_PRESCRIPTION/GRAY_SCALE/out/LINE_" + str(line)+"_WORD_"+str(word) + ".jpg", roi)
        print(x, y, w, h, "/home/shihab/OCR_PRESCRIPTION/GRAY_SCALE/out/LINE_" + str(line)+"_WORD_"+str(word) + ".jpg")
        word=word+1
    ##################################################################
...
cv2.imwrite('/home/shihab/OCR_PRESCRIPTION/GRAY_SCALE/test_grayed.png', gray)
